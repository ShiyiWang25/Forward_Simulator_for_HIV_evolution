...
def _parse_args(args, **kwargs):
    ...
    parser.add_argument('--mode', type=str, choices=['init', 'cont'], help='select mode between initiation (init) and continue (cont)')
    ...
    parser.add_argument('--start_number', default = 1, type=int, help='define the repeat number of the first simulation to run.')
    ...
    parser.add_argument('-g', default = 5, type=int, help='define the number of generations.')
    parser.add_argument('--sample_time', default = 5, type=int, help='store viral population information every x generations.')
    ...
    parser.add_argument('--redo_number', default = 1, type=int, help='set the maximum redo times for each treatment.')
    ...
    parser.add_argument('--rebound_size', default = 500, type=int, help='Define the VL to define a rebound.')
    ...
    parser.add_argument('--cores', default = 1, type=int, help='Core number to use.')
